...
from cal_pre_recall import get_coco_api_from_dataset, CocoEvaluator
import cal_pre_recall.distributed_utils_test as utils
...
def train_one_epoch(model, optimizer, data_loader, device, epoch,
    ...
    for i, [images, targets] in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        # if Truth_boxes== None:
        #     aa = 1                                                      epoch
        losses_dict, local_loss, class_loss, cos_sim_loss = model(images, targets, Truth_boxes, epoch)
